...
class TimeFilter(AttributeFilter):
    """Subclass of AttributeFilter to filter `CloseApproach` objects by time."""

    @classmethod
    def get(cls, approach):
        """Return `CloseApproach` object's time as a datetime.datetime object."""
...
class DistanceFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return `CloseApproach` object's distance."""
...
class VelocityFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return `CloseApproach` object's velocity."""
...
class DiameterFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return neo's diameter for the `CloseApproach` object."""
        return approach.neo.diameter   
    

class HazardousFilter(AttributeFilter):
    """Subclass of AttributeFilter to filter `CloseApproach` objects by it being hazardous."""

    @classmethod
    def get(cls, approach):
        """Return neo's hazardous attribute for the `CloseApproach` object."""
